...
*/
void BatchLoader::Init(Config& config)
{
...
*/
int BatchLoader::LoadBuf(FILE* file, bool isSorted, int step)
{
    int lineCount = 0;
    int seqCount = 0;
    int wordCount = 0;
...
>> flag - as it is
*/
void BatchLoader::SetRandomBatch(bool flag)
{
    isRandomBatch = flag;
}
...
*/
int BatchLoader::LoadBatch(FILE* file, bool isLM,
                           XTensor* batchEnc, XTensor* paddingEnc,
                           XTensor* batchDec, XTensor* paddingDec,
                           XTensor* gold, XTensor* label,
                           int* seqs, int vsEnc, int vsDec, int sBatch, 
                           int wBatch, bool isSorted, int& ws, int& wCount,
...
>> isTraining - indicates whether we are training the model
*/
int BatchLoader::LoadBatchLM(FILE* file,
                             XTensor* batchEnc, XTensor* paddingEnc,
                             XTensor* batchDec, XTensor* paddingDec,
                             XTensor* gold, XTensor* label,
                             int* seqs,
...
>> isTraining - indicates whether we are training the model
*/
int BatchLoader::LoadBatchMT(FILE* file,
                             XTensor* batchEnc, XTensor* paddingEnc,
                             XTensor* batchDec, XTensor* paddingDec,
                             XTensor* gold, XTensor* label,
                             int* seqs,
...
*/
void BatchLoader::Shuffle(const char* srcFile, const char* tgtFile)
{
